            ...
            <nav className="navbar navbar-expand-lg navbar-custom">
                ...
                <div className="collapse navbar-collapse">
                    ...
                    <div className="auth-links">
                        <a href="#">Đăng nhập</a> | <a href="/register">Đăng ký</a>
                    </div>
                </div>
            </nav>
                ...
                <div className="collapse navbar-collapse">
                    <ul className="navbar-nav mx-auto">
                        <li className="nav-item">
                            <a className="nav-link" href="/main">Trang chủ</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/concerts">Vé âm nhạc</a>
                        </li>
                  
                        <li className="nav-item">
                            <a className="nav-link" href="/contact">Liên hệ</a> {/* Added Contact link */}
                        </li>
                        <li className="nav-item">
